...
export const models: Model[] = [
  ...
  },
  {
    ...
    attributes: ["Pro", "New"],
    isAvailable: true,
    modelPageUrl: "https://openai.com/api/models/gpt-4.1",
    modelPriceUrl: "https://openai.com/api/pricing",
    inputPricing: "$2.00 / million tokens",
    outputPricing: "$8.00 / million tokens",
  },
  {
    id: "gpt-4.1-mini",
    name: "GPT-4.1 Mini",
    ...
    modelPriceUrl: "https://openai.com/api/pricing",
    inputPricing: "$0.40 / million tokens",
    outputPricing: "$1.60 / million tokens",
  },
  // {
  //   id: "gpt-4.5-preview",
  ...
  //   attributes: ["Pro", "New"],
  //   isAvailable: true,
  //   modelPageUrl: "https://openai.com/api/models/gpt-4.5-preview",
  //   modelPriceUrl: "https://openai.com/api/pricing",
  //   inputPricing: "$75.00 / million tokens",
  //   outputPricing: "$150.00 / million tokens",
  // },
  // {
  //   id: "gpt-o3-mini",
  //   name: "GPT-o3 Mini",
