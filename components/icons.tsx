...
export const Icons = {
  ...
  Highlevel: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      width="32"
      height="32"
      fill="none"
    ...
    >
      <path
        d="M6.972 2.781 4.113 6.08 1.92 8.613l1.92.014 1.92.014V29.6h3.733l.014-10.467.013-10.466 1.928-.027 1.927-.027-2.77-3.2a542.054 542.054 0 0 0-2.868-3.299c-.095-.096-.116-.077-.765.667m14.516 2.538-2.853 3.294 1.936.014 1.936.014V29.6h3.733V8.641l1.914-.014 1.914-.014-2.769-3.2a548.646 548.646 0 0 0-2.864-3.294c-.09-.091-.221.052-2.947 3.2m-7.849 9.206-2.868 3.315 1.948.014 1.948.014V29.6H18.4V17.868l1.925-.014 1.925-.014-2.837-3.28a1592.299 1592.299 0 0 0-2.872-3.315c-.019-.019-1.325 1.457-2.902 3.28"
        fill="currentColor"
        fillRule="evenodd"
        clipRule="evenodd"
      />
